...
class Settings(BaseSettings):
    ...
    free_tier_llm_tokens_allowance: int = 100_000
    pro_tier_llm_tokens_allowance: int = 10_000_000
    max_tier_llm_tokens_allowance: int = 70_000_000

    session_window_hours: int = 5
    weekly_window_days: int = 7
    free_tier_session_tokens_allowance: int = 5_000
    pro_tier_session_tokens_allowance: int = 500_000
    max_tier_session_tokens_allowance: int = 3_500_000
    free_tier_weekly_tokens_allowance: int = 24_000
    pro_tier_weekly_tokens_allowance: int = 2_400_000
    max_tier_weekly_tokens_allowance: int = 16_000_000
