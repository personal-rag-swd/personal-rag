...
def upgrade() -> None:
    ...
    op.drop_constraint("notebook_document_chunk_notebook_id_fkey", "notebook_document_chunk", type_="foreignkey")
    op.drop_constraint("notebook_document_chunk_user_id_fkey", "notebook_document_chunk", type_="foreignkey")
...
def downgrade() -> None:
    op.add_column("notebook_document_chunk", sa.Column("user_id", postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column("notebook_document_chunk", sa.Column("notebook_id", postgresql.UUID(as_uuid=True), nullable=True))
